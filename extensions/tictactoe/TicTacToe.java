...
public class TicTacToe  {
	...
	public static void verifyValidRow(int row) {
		if (row >= 0 && row <= 2) {
			...
			throw new IllegalArgumentException("The row must be between 0 and 2, but was instead " + row);
		}
	}
	/**
	...
	public static void verifyValidCol(int col) {
		if (col >= 0 && col <= 2) {
			...
			throw new IllegalArgumentException("The column must be between 0 and 2, but was instead " + col);
		}	
	}
	/**
